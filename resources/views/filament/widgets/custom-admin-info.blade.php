        ...
        <section x-data="{
            ...
            <div class="fi-section-content-ctn">
                <div class="fi-section-content">
                    <img class="fi-avatar fi-circular fi-size-lg fi-user-avatar" src="{{ asset('images/logo.png') }}" alt="Avatar of Md Tanvir" loading="lazy">

                    <div class="fi-account-widget-main">
                        <h2 class="fi-account-widget-heading">
                            বিদ্যুৎ ও পানি বিল ম্যানেজমেন্ট সিস্টেম
                        </h2>
