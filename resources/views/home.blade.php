                ...
                <div class="col-md-3 mt-4">
                    <div class="card shadow border-0 rounded-4">
                        <div class="card-body text-center p-5">
                            ...
                            <a href="{{ route('electic-bill') }}" class="btn btn-warning btn-lg w-100 rounded-pill shadow-sm">
                                বিদ্যুৎ বিল
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-3 mt-4">
                    <div class="card shadow border-0 rounded-4">
                        <div class="card-body text-center p-5">
                            ...
                            <h4 class="fw-bold mb-3"></h4>
                            <a href="{{ route('water-bill') }}" class="btn btn-primary btn-lg w-100 rounded-pill shadow-sm">
                                পানি বিল
                            </a>
                        </div>
                    </div>
