...
<body class="bg-warning bg-opacity-10">
    ...
    <div class="container mt-2">
        ...
        <div class="card shadow-sm mb-4 border-0">
            <div class="mt-3 text-center">
                <h1 class="h2 fw-bold mb-2"><i class=" fas fa-bolt fa-1x text-warning"></i> বিদ্যুৎ বিল পরিশোধ</h1>
            </div>
            <div class="card-body p-4">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-warning btn-lg" id="search-bill">খুঁজুন</button>
                        </div>
                        <!-- Loading Spinner -->
    ...
    <script>
        ...
        document.addEventListener('click', function(event) {
            ...
            const shopNo = btn.dataset.shopNo;
            ...
            window.location.href = `{{ route('electric.bill.gateway') }}?${params.toString()}`;
        });
    </script>
</body>
</html>